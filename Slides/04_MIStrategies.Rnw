...
types of data
% (\Rstring{"norm", "pmm", "midastouch", "logreg", "polyeg", "polr",
% "2lonly.norm", "2lonly.pmm"}),
but there are many more methods implemented.
...
\subsection{Packages worth mentioning}
\begin{frame}[fragile]{\thesection. \insertsection}
\framesubtitle{\thesection.\thesubsection. \insertsubsection}
...
% \subsection{Imputation in other software}
% \begin{frame}[fragile]{\thesection. \insertsection}
% \framesubtitle{\thesection.\thesubsection. \insertsubsection}
...
% \bigskip
% 
% Naturally, \textsf{R} is not the only statistical software that can perform
% multiple imputation.
% \begin{itemize}
...
% \subsection{Other approaches to handle missing values}
% \begin{frame}[fragile]{\thesection. \insertsection}
% \framesubtitle{\thesection.\thesubsection. \insertsubsection}
