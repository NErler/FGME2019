...
To practice the content of the previous section find 
the instructions for the practical here:\\
\begin{block}{}
\centering\url{https://nerler.com/teaching/fgme2019/mimice}
\end{block}
\end{frame}
...
the instructions for the practical here:\\
\begin{block}{}
\centering\url{https://nerler.com/teaching/fgme2019/micheck}
\end{block}
\end{frame}
