...
% Title page -------------------------------------------------------------------
\title[Multiple Imputation]{Multiple Imputation of Missing Data\\in Simple and More Complex Settings}
\author[N. Erler]{Nicole Erler}
\institute[Erasmus MC]{Department of Biostatistics, Erasmus MC\\ \url{https://nerler.com}}
\date{FGME 2019, Kiel\\15 September, 2019}
...
<<Part1a, child="01_WhatIsMI.Rnw", eval = F>>=
@
<<Part1b, child="01b_ImputationStep.Rnw", eval = F>>=
@
...
<<Part3, child="03_WhenMICEfails.Rnw", eval = FALSE>>=
@


\part{Multiple Imputation Strategies}
<<Part4, child="04_MIStrategies.Rnw", eval = FALSE>>=
@
